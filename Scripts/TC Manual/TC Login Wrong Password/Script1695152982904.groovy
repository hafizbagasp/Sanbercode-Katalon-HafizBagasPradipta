...
WebUI.setText(findTestObject('ObjManualSpy/HomepageLogin/input_Username_loginusername'), 'hafiztest')

WebUI.setText(findTestObject('ObjManualSpy/HomepageLogin/input_Password_loginpassword'), 'wrongpassword')
